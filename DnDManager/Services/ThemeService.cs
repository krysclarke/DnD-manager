...
public class ThemeService : IThemeService {
    ...
    private static readonly List<AppTheme> BuiltInThemes = new() {
        ...
        new() {
            ...
            DisplayName = "Forest",
            BaseVariant = ThemeVariant.Dark,
            CodeBlockBg = Color.Parse("#122017"),
            InlineCodeBg = Color.Parse("#1B2E20"),
            CodeText = Color.Parse("#D4E8D0"),
            BlockquoteBorder = Color.Parse("#3E6B3A"),
            LinkColor = Color.Parse("#81C784"),
            TableBorder = Color.Parse("#2E5230"),
            MutedText = Color.Parse("#9CBF98"),
            RuleBrush = Color.Parse("#3E6B3A"),
            Nat1Brush = Color.Parse("#FF6B6B"),
            Nat20Brush = Color.Parse("#B9F6CA"),
            Nat1Bg = Colors.Transparent,
            Nat20Bg = Colors.Transparent,
            OverlayBg = Color.Parse("#CC0A140D"),
            DialogBg = Color.Parse("#FF16241A"),
            ActiveHighlight = Color.Parse("#404CAF50"),
            HoverHighlight = Color.Parse("#20D4E8D0"),
            Surface = Color.Parse("#16241A"),
            Accent = Color.Parse("#2E7D32"),
            AccentForeground = Color.Parse("#FFFFFF")
        },
        new() {
            Id = "infernal",
            ...
            BaseVariant = ThemeVariant.Dark,
            CodeBlockBg = Color.Parse("#1F0E0D"),
            InlineCodeBg = Color.Parse("#2E1614"),
            CodeText = Color.Parse("#F5D6D0"),
            BlockquoteBorder = Color.Parse("#8B3A2F"),
            LinkColor = Color.Parse("#FF8A65"),
            TableBorder = Color.Parse("#5A2A22"),
            MutedText = Color.Parse("#C99B92"),
            RuleBrush = Color.Parse("#8B3A2F"),
            Nat1Brush = Color.Parse("#FFFFFF"),
            Nat20Brush = Color.Parse("#FFFFFF"),
            Nat1Bg = Color.Parse("#7F0000"),
            Nat20Bg = Color.Parse("#2E7D32"),
            OverlayBg = Color.Parse("#CC140807"),
            DialogBg = Color.Parse("#FF241413"),
            ActiveHighlight = Color.Parse("#40E74C3C"),
            HoverHighlight = Color.Parse("#20F5D6D0"),
            Surface = Color.Parse("#241413"),
            Accent = Color.Parse("#C0392B"),
            AccentForeground = Color.Parse("#FFFFFF")
        },
        new() {
            Id = "dungeon",
            DisplayName = "Dungeon",
            BaseVariant = ThemeVariant.Dark,
            CodeBlockBg = Color.Parse("#21252B"),
            InlineCodeBg = Color.Parse("#2E343C"),
            CodeText = Color.Parse("#CDD3DA"),
            BlockquoteBorder = Color.Parse("#4A525C"),
            LinkColor = Color.Parse("#8AB4D8"),
            TableBorder = Color.Parse("#3C434C"),
            MutedText = Color.Parse("#9AA3AD"),
            RuleBrush = Color.Parse("#4A525C"),
            Nat1Brush = Color.Parse("#E57373"),
            Nat20Brush = Color.Parse("#81C784"),
            Nat1Bg = Colors.Transparent,
            Nat20Bg = Colors.Transparent,
            OverlayBg = Color.Parse("#CC15171B"),
            DialogBg = Color.Parse("#FF2B2F36"),
            ActiveHighlight = Color.Parse("#406B7D8C"),
            HoverHighlight = Color.Parse("#20CDD3DA"),
            Surface = Color.Parse("#2B2F36"),
            Accent = Color.Parse("#5C7080"),
            AccentForeground = Color.Parse("#FFFFFF")
        },
        new() {
            Id = "royal",
            DisplayName = "Royal",
            BaseVariant = ThemeVariant.Dark,
            CodeBlockBg = Color.Parse("#1B1810"),
            InlineCodeBg = Color.Parse("#2A2418"),
            CodeText = Color.Parse("#EFE3C2"),
            BlockquoteBorder = Color.Parse("#8A6D2A"),
            LinkColor = Color.Parse("#E6C260"),
            TableBorder = Color.Parse("#5A4A22"),
            MutedText = Color.Parse("#C2B188"),
            RuleBrush = Color.Parse("#8A6D2A"),
            Nat1Brush = Color.Parse("#FF6B6B"),
            Nat20Brush = Color.Parse("#FFE082"),
            Nat1Bg = Colors.Transparent,
            Nat20Bg = Colors.Transparent,
            OverlayBg = Color.Parse("#CC14110A"),
            DialogBg = Color.Parse("#FF221E16"),
            ActiveHighlight = Color.Parse("#40D4AF37"),
            HoverHighlight = Color.Parse("#20EFE3C2"),
            Surface = Color.Parse("#221E16"),
            Accent = Color.Parse("#C9A227"),
            AccentForeground = Color.Parse("#1A1500")
        },
        new() {
            Id = "frost",
            DisplayName = "Frost",
            BaseVariant = ThemeVariant.Light,
            CodeBlockBg = Color.Parse("#DCEAF0"),
            InlineCodeBg = Color.Parse("#CFE2EA"),
            CodeText = Color.Parse("#15323D"),
            BlockquoteBorder = Color.Parse("#8FB8C7"),
            LinkColor = Color.Parse("#0E6E8C"),
            TableBorder = Color.Parse("#A9C9D6"),
            MutedText = Color.Parse("#4E6B75"),
            RuleBrush = Color.Parse("#8FB8C7"),
            Nat1Brush = Color.Parse("#FFFFFF"),
            Nat20Brush = Color.Parse("#FFFFFF"),
            Nat1Bg = Color.Parse("#B71C1C"),
            Nat20Bg = Color.Parse("#2E7D32"),
            OverlayBg = Color.Parse("#80000000"),
            DialogBg = Color.Parse("#FFEAF4F8"),
            ActiveHighlight = Color.Parse("#4029B6D8"),
            HoverHighlight = Color.Parse("#20000000"),
            Surface = Color.Parse("#E8F1F5"),
            Accent = Color.Parse("#1B7A99"),
            AccentForeground = Color.Parse("#FFFFFF")
        }
    };
